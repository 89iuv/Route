route.service('LocationRepository', ['RouteConfigConstant', 'ComponentRepository', function(RouteConfigConstant, ComponentRepository){
    var url = RouteConfigConstant.REST_API_URL + "/" + RouteConfigConstant.LOCATION_URL;
    var state = [];
