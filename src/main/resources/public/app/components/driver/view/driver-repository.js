route.service('DriverRepository', ['RouteConfigConstant', 'ComponentRepository', function(RouteConfigConstant, ComponentRepository){

    var state = [];
    var url = RouteConfigConstant.REST_API_URL + "/" + RouteConfigConstant.DRIVER_URL;
