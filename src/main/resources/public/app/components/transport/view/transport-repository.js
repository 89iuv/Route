route.service('TransportRepository', ['RouteConfigConstant', 'ComponentRepository', function(RouteConfigConstant, ComponentRepository){
    var url = RouteConfigConstant.REST_API_URL + "/" + RouteConfigConstant.TRANSPORT_URL;
    var state = [];
